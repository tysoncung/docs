...
<Columns cols={2}>
    <Card title="ChatVertexAI" icon="messages" href="/oss/python/integrations/chat/google_vertex_ai" cta="Get started" arrow>
...
<Columns cols={2}>
    ...
    <Card title="VertexAI" icon="cursor-text" href="/oss/python/integrations/llms/google_vertex_ai" cta="Get started" arrow>
...
<Columns cols={2}>
    <Card title="VertexAIEmbeddings" icon="stack-2" href="/oss/python/integrations/text_embedding/google_vertex_ai" cta="Get started" arrow>
...
<Columns cols={2}>
    ...
    <Card title="cloro" icon="search" href="/oss/python/integrations/tools/cloro" cta="Get started" arrow>
        cloro provides API access to Google Search results, with AI Overview support.
    </Card>
</Columns>
